...
class EWatchList extends StatefulWidget {
  const EWatchList({super.key});

  @override
  State<EWatchList> createState() => _EWatchListState();
}

class _EWatchListState extends State<EWatchList> with CompletableMixin {
