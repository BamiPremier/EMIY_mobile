  ...
  Widget build(BuildContext context) {
    return BlocBuilder<PersonCubit, PersonState>(
      builder: (context, state) {
        ...
        if (personCubit.user.id == userCubit.user.id) return const SizedBox();
        ...
        if (personCubit.user.hasBlocked) {
          ...
          text = Text(
            ...
            style: Theme.of(context).textTheme
              .labelLarge!.copyWith(color: AppTheme.white),
          );
          ...
          } else icon = const Icon(Icons.block_flipped);
          ...
          } else icon = const Icon(Icons.check);
        } else {
          ...
          } else icon = const Icon(Icons.add);
        }
