...
extension AnimeBlockFilterExtension on AnimeBlockFilter {
  String get name {
    switch (this) {
      case AnimeBlockFilter.trending: return 'TRENDING_NOW';
      case AnimeBlockFilter.nextSeason: return 'POPULAR_THIS_SEASON';
      case AnimeBlockFilter.all: return 'POPULAR_ALL_TIME';
    }
  }
}